...
class BaseAviary(gym.Env):
    ...
    def __init__(self,
        ...
        self.URDF_PATH = os.path.join("Sol/resources", self.DRONE_MODEL.value + '.urdf')
        self.URDF_PATH = os.path.join("Sol/resources/safegym", self.DRONE_MODEL.value + '.urdf')
    ...
    def _parse_urdf_parameters(self, file_name):
        ...
        files in folder `assets/`.
        '''
        print("Attempting to open:", self.URDF_PATH)
