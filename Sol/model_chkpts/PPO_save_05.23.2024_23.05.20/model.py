class PBDroneEnv(
    ...
    def _computeObs(self):
        ...
        try:
            ...
            ret = ret.astype('float32')  # Ensure the array is of type float32

            assert isinstance(ret, np.ndarray) and ret.dtype == np.float32, "The observation is not a numpy array of type float32"
